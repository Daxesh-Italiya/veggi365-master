...
class _EditAddressScreenState extends State<EditAddressScreen> {
  ...
  void initState() {
    ...
    _currentCity = widget.address.cityName;
    address.text = widget.address.userAddressName;
                ...
                children: [
                  ...
                  GestureDetector(
                    onTap: () {
                      ...
                      // }else{
                      updateAddress(address.text, _currentCity, pinCode.text,_currentState);
                      // }
                    },
                    child: CustomButton(
                      height: 50,
  ...
  Future<String> updateAddress(
    ...
    var response = await http.Client().patch(Uri.parse(URL_ADD_ADDRESS),
        headers: await getHeader(),
        body: json.encode({
            {
              "user_address_id": widget.address.userAddressId ?? "",
    ...
    if(response.statusCode == 200) {
      ...
      if (message["status"] == "success") {
        Utils.showToast("Address updated!");
        Get.back();
      ...
      Utils.showToastError(response.body);
    }
